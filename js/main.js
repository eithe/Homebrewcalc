...
$().ready(function () {
  ...
  // weight calc
  var wcGramChangeHandler = function () { wcGram(); }
  $('#WCGramInput').on(events, wcGramChangeHandler);

  var wcKilogramChangeHandler = function () { wcKilogram(); }
  $('#WCKilogramInput').on(events, wcKilogramChangeHandler);

  var wcOzChangeHandler = function () { wcOz(); }
  $('#WCOzInput').on(events, wcOzChangeHandler);

  var wcLbChangeHandler = function () { wcLb(); }
  $('#WCLbInput').on(events, wcLbChangeHandler);
...
function wcGram() {
  var $gramEl = $('#WCGramInput');
  var $kgEl = $('#WCKilogramInput');
  var $ozEl = $('#WCOzInput');
  var $lbEl = $('#WCLbInput');

  var gram = getGenericNumberVal($gramEl);
...
function wcKilogram() {
  ...
  var kg = getGenericNumberVal($kgEl);
